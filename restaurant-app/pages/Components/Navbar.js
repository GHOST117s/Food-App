...
//update the cart to quantity
  ...
  <div  role="button" className="relative flex">
    <svg className="flex-1 w-8 h-8 fill-current" viewBox="0 0 24 24">
      ...
      <span className="absolute right-0 top-0 rounded-full bg-red-600 w-3.5 h-3.5 top right p-0 m-0 text-white font-mono text-sm  leading-tight text-center">{carts}
    </span>
  </div>
</li>
